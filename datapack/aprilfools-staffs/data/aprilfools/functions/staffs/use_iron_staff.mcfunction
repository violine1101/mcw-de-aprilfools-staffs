...
execute if score durability af_var matches 32.. run function aprilfools:staffs/break_staff

scoreboard players operation durability af_var *= TWENTYFIVE af_var
scoreboard players operation durability af_var /= THIRTYTWO af_var
